...
def classement(epreuve):
    ...
    while z<=n:
        ...
        for part in p:
            ...
            if dif_barr>0:
                point_barr += ceil(dif_barr)*app.config['A_TEMPS_DEPASSE_2PHASE']
            if dif_barr2 > 0:
                point_barr2 += ceil(dif_barr2)*app.config['A_TEMPS_DEPASSE_2PHASE']
...
def getDesc():
    return 'Barème A avec chrono en deux phases'